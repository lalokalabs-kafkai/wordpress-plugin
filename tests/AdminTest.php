...
class AdminTest extends TestCase {
   ...
   * @covers ::meta_links
    ...
    $this->assertEquals(
      ...
      $admin->meta_links( ['first_link', 'second_link'], 'diff-plugin.php' )
    );
  }
   ...
   * @covers ::meta_links
    ...
    $this->assertEquals(
      ['first_link', 'second_link', '<a href="https://kafkai.com" target="_blank">Website</a>'],
      $admin->meta_links( ['first_link', 'second_link'], 'kafkai.php' )
    );
  }
